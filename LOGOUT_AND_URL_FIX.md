...
The issue where you're seeing `https://ecom-return-manager.preview.emergentagent.com/app/dashboard` instead of the correct URL is likely due to browser caching or old localStorage data.
...
**Step 2: Hard Refresh**
1. **Navigate to:** `https://ecom-return-manager.preview.emergentagent.com/auth/login`
...
### 🎯 **CORRECT URLS TO USE:**
- **Login:** `https://ecom-return-manager.preview.emergentagent.com/auth/login`
- **Merchant Dashboard:** `https://ecom-return-manager.preview.emergentagent.com/app/dashboard`
- **Admin Dashboard:** `https://ecom-return-manager.preview.emergentagent.com/admin/dashboard`

...
1. **Update Shopify App Settings:**
   ...
   - Set "App URL": `https://multi-tenant-rms.preview.emergentagent.com/app`
   - Set "Allowed redirection URLs": `https://multi-tenant-rms.preview.emergentagent.com/api/auth/shopify/callback`
   - **Important**: No trailing slashes!

2. **Update Environment:**
   ```bash
   # Update backend/.env
   APP_URL=https://multi-tenant-rms.preview.emergentagent.com
...
# Callback should be:
# https://multi-tenant-rms.preview.emergentagent.com/api/auth/shopify/callback
```

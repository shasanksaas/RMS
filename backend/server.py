...
from src.controllers.public_form_config_controller import router as public_form_config_router  # Public form config
...
from src.controllers.shopify_oauth_controller import router as shopify_oauth_router, integration_router as shopify_oauth_integration_router
from src.controllers.shopify_integration_controller import router as shopify_integration_router
...
api_router.include_router(form_config_router)  # Form customization and branding
...
app.include_router(public_form_config_router, prefix="/api")  # Public form config now under /api/public for ingress compatibility

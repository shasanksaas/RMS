...
class ShopifyAuthService:
    ...
    def __init__(self):
        ...
        self.base_redirect_uri = os.environ.get('SHOPIFY_REDIRECT_URI', 'https://returnflow-4.preview.emergentagent.com/api/auth/shopify/callback')
    ...
    async def register_shopify_webhooks(self, shop: str, access_token: str) -> None:
        ...
        try:
            ...
            webhook_base_url = "https://returnflow-4.preview.emergentagent.com/api/webhooks/shopify"
